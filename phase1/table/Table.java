...
public class Table {
  ...
  public void clear() {
    ...
    cost = 0;
    order = new ArrayList<>();
    System.out.println("backend/table " + tableNum + " has been cleared");
  }
  ...
  /**
   * prints bill for this backend.table in format of Table number and all dishes with its price and the total
   * price
   */
