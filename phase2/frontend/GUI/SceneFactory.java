  ...
  public Scene createScene(int type, int id) throws IOException {
    ...
    if (type == Packet.COOKTYPE) {
      ...
      FXMLLoader cookLoader =
          new javafx.fxml.FXMLLoader(this.getClass().getResource("/frontend/GUI/Cook.fxml"));
      ...
      FXMLLoader serverLoader =
          new javafx.fxml.FXMLLoader(this.getClass().getResource("/frontend/GUI/ServerStage.fxml"));
      Parent server = serverLoader.load();
      scene = new Scene(server, WIDTH, HEIGHT);

      // load menu interface
      FXMLLoader menuLoader =
          new FXMLLoader(this.getClass().getResource("/frontend/GUI/Menu.fxml"));
      ...
      FXMLLoader managerLoader =
          new javafx.fxml.FXMLLoader(this.getClass().getResource("/frontend/GUI/Manager.fxml"));
