...
public class RestaurantLogger {
  ...
  public static void init() {
    ...
    try {
      outPS = new PrintStream(new BufferedOutputStream(new FileOutputStream("logFile.log", true)));
...
//    logger.log(Level.INFO, "message 1"); // INFO: Default level.
//    System.out.println("sout");
//
//    // CONFIG Level is lower than INFO level, so it doesn't show on log.
//    logger.log(Level.CONFIG, "message 2");
